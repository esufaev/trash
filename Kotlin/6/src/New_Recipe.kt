data class New_Recipe (val title: String,
...
fun findRecipes( title: String = "",
                 ...
                 difficulty:String = "Easy"): Array<New_Recipe> {
    return arrayOf(New_Recipe(title,ingredient,isVegetarian,difficulty))
}
...
fun main(args : Array<String>){
    val r1 = New_Recipe("Thai Curry","Chicken")
    val r2 = New_Recipe(title = "Thai Curry", mainIngredient = "Chicken")
